...
CREATE TABLE import_license (
	license_id TEXT,
	license_title TEXT,
	license_url TEXT
);

CREATE TABLE import_language (
    language_id TEXT,
	language_code TEXT,
	language_name TEXT,
...
CREATE TABLE import_track_genre (
    track_id TEXT,
    genre_id TEXT
);
